...
途中で iptables の確認を求められた場合は内容を確認して Yes を選択する。

使うmicroSDカードやRaspberry Piの種類にもよるが、完了までに約5~10分はかかる。
...
このイメージはZUIKI公式81MB HDDイメージにPPP接続に必要なソフトウェアを追加で導入して構成したものです。すべて再配布可能であることを確認した上で、以下のソフトウェアを利用させていただいています。この場を借りてお礼申し上げます。
...
この文書の筆者である tantan が独自に対症療法的なパッチを行ったものを組み込んであります。
...
* JavaScriptを使ったサイトが見れない

やってやれないことはないのですが、やってませんw
...
* 2023.10.15 ... Raspberry Pi OS Lite 32-bit 2023-10-10 リリース版に対応したインストールスクリプトの更新
* 2023.09.27 ... 初版
