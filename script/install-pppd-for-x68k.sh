...
# install webxpressd
apt-get install -y git libopenjp2-7 libxslt1-dev libcairo2-dev libjpeg-dev python3-pip python3-bs4 python3-pil python3-freetype python3-svglib python3-cairo python3-lxml cmake
sudo -u pi pip install --break-system-packages git+https://github.com/tantanGH/webxpressd.git
